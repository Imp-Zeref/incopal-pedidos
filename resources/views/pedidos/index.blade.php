                ...
                <thead class="border-b">
                    <tr>
                        ...
                        @if (auth()->user()->tipoUsuario->nome === 'Administrador')
                            <th class="py-3 px-4 text-left text-gray-600 font-semibold">Vendedor</th>
                        @endif
                ...
                <tbody>
                    @forelse ($pedidos as $pedido)
                        <tr class="hover:bg-gray-50 border-b">
                            ...
                            @if (auth()->user()->tipoUsuario->nome === 'Administrador')
                                <td class="py-3 px-4">{{ $pedido->usuario->nome }}</td>
                            @endif
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ auth()->user()->tipoUsuario->nome === 'Administrador' ? 7 : 6 }}" class="py-4 px-4 text-center text-gray-500">
